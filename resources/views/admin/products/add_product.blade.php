...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المنتج</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    اضافة منتج</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            {{-- <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="product_number"
                                    title="يرجي ادخال رقم المنتج" required>
                            </div> --}}
                            <div class="col">
                                <label for="inputName" class="control-label">اسم المنتج </label>
                                <input type="text" class="form-control" id="inputName" name="name"
                                    title="يرجي ادخال أسم المنتج" required>
                            </div>

                            <div class="col">
                                <label> وحدة المنتج</label>
                                <div class="form-group">
                                    <select name="unity" class="form-control select2-no-search my-3">
                                        <option label="وحدة المنتج">
                                        </option>
                                        <option value="item">
                                            حبه
                                        </option>
                                ...
                                {{-- <input type="text"  class="form-control" name="unity" placeholder="قم بدخال الوحده"
                                     required> --}}
                            </div>
                            <div class="col">
                                <label>هل تريد جعل المنتج مفعل؟</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label>رقم sku</label>
                                <input type="number"  class="form-control" name="sku" placeholder="رقم"
                                     required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="inputName" name="sale_price"
                                    title="سعر الشراء" required>
                            </div>

                            <div class="col">
                                <label>سعر البيع</label>
                                <input type="number"  class="form-control" name="buy_price" placeholder="سعر البيع"
                                    required>
                            </div>
                        </div>
                        {{-- <div class="row">
