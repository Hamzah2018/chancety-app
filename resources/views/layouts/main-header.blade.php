                ...
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/Yemen_flag.png')}}" alt="img"></span>
                            <div class="my-auto">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        {{--$user->id    [$user->id]  --}}
                        {{-- <a class="dropdown-item" href="{{route('users.edit',auth()->user()->id)}}"><i class="bx bx-user-circle"></i>الملف الشخصي</a> --}}
                        {{-- <a class="dropdown-item" href="{{route('users.edit',$users->id)}}"><i class="bx bx-user-circle"></i>الملف الشخصي</a> --}}
